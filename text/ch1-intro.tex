...
Whether it's a doctor prescribing the most effective treatment for a patient or a company launching a marketing campaign that resonates with its target audience \citep{xu2020contextual,li2010contextual,bastani2019online}, we constantly strive to take actions that lead to desirable outcomes. 
...
In this chapter we consider dynamic treatment regimes (DTRs), where the available observational data may suffer from unmeasured confounding. 
...
To be considered accurate, these models must correctly capture the true interventional behaviour of outcomes, $\X_{0:\tx}(\ax_{1:\tx})$.
